...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_fancy_gallery_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/fancy-gallery.js */ "./src/js/components/fancy-gallery.js");
...
const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_2__["default"]('tabs-single');
...
// const term_btn = document.querySelector('#term-btn');
// const term_toolt = document.querySelector('#term-toolt');
// createPopper(term_btn, term_toolt, {
//   placement: 'top-start',
// });
...
/***/ "./src/js/components/fancy-gallery.js":
/*!********************************************!*\
  !*** ./src/js/components/fancy-gallery.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _fancyapps_ui___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @fancyapps/ui/ */ "./node_modules/@fancyapps/ui/dist/index.esm.js");
/* harmony import */ var _fancyapps_ui_dist_carousel_carousel_thumbs_esm_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @fancyapps/ui/dist/carousel/carousel.thumbs.esm.js */ "./node_modules/@fancyapps/ui/dist/carousel/carousel.thumbs.esm.js");
...
new _fancyapps_ui___WEBPACK_IMPORTED_MODULE_0__.Carousel(document.getElementById('productCarousel'), {
  infinite: false,
  Dots: false,
  Thumbs: {
    type: 'classic',
  ...
  Thumbs: _fancyapps_ui_dist_carousel_carousel_thumbs_esm_js__WEBPACK_IMPORTED_MODULE_1__.Thumbs
});
_fancyapps_ui___WEBPACK_IMPORTED_MODULE_0__.Fancybox.bind('[data-fancybox="gallery"]', {
  idle: false,
  compact: false,
  dragToClose: false,
  animated: false,
...
const term_btn = document.querySelector('#term-btn');
const term_toolt = document.querySelector('#term-toolt');
(0,_popperjs_core__WEBPACK_IMPORTED_MODULE_0__.createPopper)(term_btn, term_toolt, {
  placement: 'top-start'
});
const mil_btn = document.querySelector('#mil-btn');
const mil_toolt = document.querySelector('#mil-toolt');
(0,_popperjs_core__WEBPACK_IMPORTED_MODULE_0__.createPopper)(mil_btn, mil_toolt, {
  placement: 'top-start'
});
const paym_btn = document.querySelector('#paym-btn');
const paym_toolt = document.querySelector('#paym-toolt');
(0,_popperjs_core__WEBPACK_IMPORTED_MODULE_0__.createPopper)(paym_btn, paym_toolt, {
  placement: 'top-start'
});
const dep_btn = document.querySelector('#dep-btn');
const dep_toolt = document.querySelector('#dep-toolt');
(0,_popperjs_core__WEBPACK_IMPORTED_MODULE_0__.createPopper)(dep_btn, dep_toolt, {
  placement: 'top-start'
});
const tooltips = document.querySelectorAll('.info-block__tooltip');
tooltips.forEach(tooltip => {
  const info_block_btn = tooltip.querySelector('.info-block__btn');
  const info_block_toolt = tooltip.querySelector('.info-block__txt');
  (0,_popperjs_core__WEBPACK_IMPORTED_MODULE_0__.createPopper)(info_block_btn, info_block_toolt, {
    placement: 'left'
  });
});
const tooltipsfinance = document.querySelectorAll('.finance-form__form-info');
tooltipsfinance.forEach(tooltip => {
  const finance_form_btn = tooltip.querySelector('.finance-form__btn');
  const finance_form_toolt = tooltip.querySelector('.finance-form__txt');
  (0,_popperjs_core__WEBPACK_IMPORTED_MODULE_0__.createPopper)(finance_form_btn, finance_form_toolt, {
    placement: 'left'
  });
});
