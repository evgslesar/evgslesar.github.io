...
/* harmony import */ var _components_catalog_tabs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/catalog-tabs.js */ "./src/js/components/catalog-tabs.js");
/* harmony import */ var _components_catalog_tabs_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_catalog_tabs_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_phone_input_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/phone-input.js */ "./src/js/components/phone-input.js");
/* harmony import */ var _components_phone_input_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_phone_input_js__WEBPACK_IMPORTED_MODULE_2__);
...
document.addEventListener('DOMContentLoaded', () => {
  const accordions = document.querySelectorAll('.accordion__open-btn');
  accordions.forEach(el => {
    el.addEventListener('click', e => {
      const self = e.currentTarget.parentNode.parentNode;
      const control = self.querySelector('.accordion__open-btn');
...
buttons.forEach(button => {
  button.addEventListener("click", event => {
    ...
    const number = parseInt(numberContainer.value);
    ...
    const newNumber = element.classList.contains("plus") ? number + 1 : number - 1;
...
/***/ "./src/js/components/catalog-tabs.js":
/*!*******************************************!*\
  !*** ./src/js/components/catalog-tabs.js ***!
  \*******************************************/
/***/ (() => {

const catalogTabsNav = document.querySelector('.pizzas-section__tabs-nav');
const catalogTabsBtns = document.querySelectorAll('.pizzas-section__tabs-nav-btn');
const catalogTabsItems = document.querySelectorAll('.pizzas-section__card');
const catalogTabsItemsVisible = document.querySelectorAll('.pizzas-section__card--visible');
if (catalogTabsNav) {
  catalogTabsNav.addEventListener('click', e => {
    const target = e.target;
    if (target.classList.contains('pizzas-section__tabs-nav-btn')) {
      const path = target.dataset.path;
      catalogTabsBtns.forEach(el => {
        el.classList.remove('pizzas-section__tabs-nav-btn--active');
      });
      target.classList.add('pizzas-section__tabs-nav-btn--active');
      catalogTabsItems.forEach(el => {
        el.classList.remove('pizzas-section__card--visible');
      });
      document.querySelectorAll(`[data-target="${path}"]`).forEach(el => {
        el.closest('.pizzas-section__card').classList.add('pizzas-section__card--visible');
      });
      if (path == 'all') {
        catalogTabsItems.forEach(el => {
          el.classList.add('pizzas-section__card--visible');
        });
      }
    }
  });
...
/***/ "./src/js/components/phone-input.js":
/*!******************************************!*\
  !*** ./src/js/components/phone-input.js ***!
  \******************************************/
/***/ (() => {
...
const swiper_main_thumbs = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper_main_thumbs", {
  spaceBetween: 10,
  slidesPerView: 3,
  loop: true,
  freeMode: true,
...
const swiper_main = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper_main", {
  loop: true,
  slidesPerView: 2,
  spaceBetween: 10,
  thumbs: {
    swiper: swiper_main_thumbs
  },
  navigation: {
    nextEl: ".main-hero__next",
    prevEl: ".main-hero__prev"
  },
  breakpoints: {
    930: {
      slidesPerView: 1
...
var swiper_featured = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".featured__slider", {
  spaceBetween: 10,
  slidesPerView: 2,
  loop: true,
  navigation: {
